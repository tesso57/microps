...
#define ETHER_ADDR_LEN 6 // Ethernetアドレスのバイト長
...
#define ETHER_TYPE_IPV6 0x086dd
...
typedef ssize_t (*ether_input_func_t)(struct net_device *dev, uint8_t *buf, size_t len);
